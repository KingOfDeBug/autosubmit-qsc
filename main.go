...
var reason = flag.String("reason", "", "出入校事由详细描述")
var reasonxx = flag.String("reasonxx", "科研", "出入校事由")
var track = flag.String("track", "", "出校行动轨迹")
var ftKey string
...
func initFlags() {
	...
	if *username == "" || *password == "" || *reason == "" || *track == "" {
		panic("Must specify username and password and reason and track")
	}
}
